...
<div class="max-w-4xl mx-auto">
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="text-gray-600 mt-1">Lengkapi informasi buku di bawah ini.</p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
        <form action="{{ route('buku.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
            @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            <div class="flex items-center justify-center w-full">
                                <label for="cover_image" class="flex flex-col items-center justify-center w-full h-44 border-2 border-gray-300 border-dashed rounded-2xl cursor-pointer bg-gray-50 hover:bg-gray-100 transition-all group-hover:border-blue-400">
                                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                        ...
                                        <p class="mb-2 text-sm text-gray-500"><span class="font-semibold">Klik untuk unggah</span> atau seret file</p>
                            ...
                            <div id="image-preview-container" class="hidden mt-4">
                                <img id="image-preview" src="#" alt="Preview" class="w-full h-44 object-contain rounded-xl border border-gray-200">
                            </div>
                        </div>
                        @error('cover_image')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <textarea name="synopsis" id="synopsis" rows="3" 
                            ...
                            placeholder="Ringkasan cerita buku...">{{ old('synopsis') }}</textarea>
                        @error('synopsis')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="mt-10 pt-8 border-t border-gray-100 flex justify-end space-x-4">
                <button type="reset" class="px-6 py-3 rounded-xl border border-gray-200 text-gray-600 font-semibold hover:bg-gray-50 transition-all">
                    Reset
                </button>
